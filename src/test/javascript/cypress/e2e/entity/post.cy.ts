...
describe('Post e2e test', () => {
  ...
  const postSample = {
    title: 'when loosely failing',
    content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=',
    date: '2024-04-20T18:33:31.763Z',
  };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('recklessly inlay warmly');
      cy.get(`[data-cy="title"]`).should('have.value', 'recklessly inlay warmly');
      ...
      cy.get(`[data-cy="date"]`).type('2024-04-20T03:08');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-04-20T03:08');
