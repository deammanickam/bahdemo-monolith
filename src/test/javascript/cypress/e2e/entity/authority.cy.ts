...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '205a51c9-0e89-435b-8c6e-6a78b48e1ea3' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('a6d06998-8625-4cee-b697-a371e44bc58d');
      cy.get(`[data-cy="name"]`).should('have.value', 'a6d06998-8625-4cee-b697-a371e44bc58d');
