...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 25865 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 6022 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 1194 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 3053 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 32541 };
      post.blog = blog;
      const tag: ITag = { id: 21616 };
      post.tags = [tag];
